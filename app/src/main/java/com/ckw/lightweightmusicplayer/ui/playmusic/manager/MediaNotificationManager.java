...
import com.ckw.lightweightmusicplayer.ui.playmusic.helper.ResourceHelper;
 ...
 * 跟踪一个通知，并自动更新它，为一个给定的MediaSession。
 * 维护一个可见的通知(通常)保证音乐服务不会在播放期间被杀死。
 */
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    public void startNotification() {
        if (!mStarted) {
            if(mController != null && mController.getMetadata() != null){
    ...
    private PendingIntent createContentIntent(MediaDescriptionCompat description) {
        ...
        openUI.putExtra(MusicPlayActivity.EXTRA_START_FULLSCREEN, true);
        if (description != null) {
            openUI.putExtra(MusicPlayActivity.EXTRA_CURRENT_MEDIA_DESCRIPTION, description);
        }
    ...
    private Notification createNotification() {
        ...
        notificationBuilder
                ...
                .setSmallIcon(R.drawable.bg_music)
